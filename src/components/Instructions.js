    ...
    <div style={InstructionsStyle}>
      ...
      <p>
        ...
        <ul style={alignLeft}>
          ...
          <li><strong>Big oops??</strong> If you messed up a keg's details, don't fret! From that beer's details page, click the "Update" button to edit the keg's information. All better! (NOTE: the updated keg will move to the bottom of the keg list)</li>
